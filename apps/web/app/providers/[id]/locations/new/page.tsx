// apps/web/app/providers/[id]/locations/new/page.tsx
...
import { ProviderStatus, VerificationStatus } from "../../../../../lib/providers/models/enums";
...
export default function AddLocationPage(props: NewLocationPageProps) {
  ...
  const [latitude, setLatitude] = useState(17.3850); // Default to Hyderabad
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const formData: ProviderLocationFormData = {
    ...
    try {
      ...
      await service.createLocation(providerId, formData, userId);
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      ...
      <div>
        <h1 className="text-xl font-extrabold text-slate-900">Add Branch Location</h1>
        <p className="text-xs text-muted-foreground mt-0.5">
          Register a physical laboratory branch or scan center under {provider.brandName}.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-white border border-slate-100 rounded-xl p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-[11px] font-bold text-slate-700 mb-1">
                Unique Location Code <span className="text-rose-500">*</span>
              </label>
              <input
                type="text"
                placeholder="E.g., LOC-APOLLO-INDIRANAGAR"
                value={code}
                ...
                <div key={index} className="flex justify-between items-center text-xs bg-white border rounded-lg p-2.5">
                  <div className="space-y-0.5">
                    <div className="font-bold text-slate-800 flex items-center gap-1.5">
                      ...
                      <span className="px-1.5 py-0.5 text-[9px] font-semibold bg-amber-50 text-amber-700 rounded-full border">Pending verification</span>
                    </div>
        ...
        <div className="pt-4 border-t border-slate-100 flex gap-3 justify-end">
          ...
          >
            {submitting ? "Saving..." : <span className="flex items-center gap-1.5"><Check className="h-4 w-4" /> Save Branch Location</span>}
          </button>
        </div>
      </form>
    </div>
